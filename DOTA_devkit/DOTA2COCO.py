...
if __name__ == '__main__':
    ...
    DOTA2COCOTrain(r'dota_ms_1024/trainval_split',
                   r'dota_ms_1024/trainval_split/DOTA_trainval1024_ms.json',
                   wordname_15)
    DOTA2COCOTest(r'dota_ms_1024/test_split',
                   r'/dota_ms_1024/test_split/DOTA_test1024_ms.json',
                   wordname_15)
