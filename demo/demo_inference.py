...
from mmdet.apis import init_detector, inference_detector, draw_poly_detections, draw_poly_mask_detections
from mmdet.datasets import get_dataset

def save_det_result(config_file, checkpoint_file, img_dir=None, out_dir=None, score_thr=0.2):
    ...
    for img_name in img_list:
        ...
        img = draw_poly_mask_detections(img_path,
                                   result,
                                   classnames,
                                   scale=1.0,
                                   threshold=score_thr,
...
if __name__ == '__main__':
    ...
    save_det_result(args.config_file, args.checkpoint_file, img_dir=args.img_dir, out_dir=args.out_dir, score_thr=0.5)
