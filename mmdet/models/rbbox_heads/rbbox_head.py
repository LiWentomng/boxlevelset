...
from mmdet.core import delta2dbbox, multiclass_nms_rbbox, \
    ...
    Pesudomulticlass_nms_rbbox, delta2dbbox_v3, hbb2obb_v2, multiclass_nms_polybbox
...
class BBoxHeadRbbox(nn.Module):
    ...
    def loss(self,
        ...
        if bbox_pred is not None:
            ...
            # print('bbox_targets[pos_inds]', bbox_targets[pos_inds].shape, bbox_targets[pos_inds])
    ...
    def get_det_rbboxes(self,
        ...
        if rbbox_pred is not None:
            ...
            dbboxes = rrois[:, 1:]
            # TODO: add clip here
        # print('get_box_rescale', rescale)#True
        if rescale:
            # bboxes /= scale_factor
            # dbboxes[:, :4] /= scale_factor
            dbboxes[:, 0::5] /= scale_factor
        ...
        if cfg is None:
            ...
            c_device = dbboxes.device
            # print('dbboxes', dbboxes.shape, dbboxes)
            # det_rbboxes, det_rlabels = multiclass_nms_polybbox(
            #     aug_rbboxes, aug_rscores, rcnn_test_cfg.score_thr,
